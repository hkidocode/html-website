            ...
            class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
                ...
                getSwiperSettings() {
                    ...
                    Object.keys(i).reverse().forEach((t => {
                        ...
                        }, e.image_spacing_custom && (o.breakpoints[i[t].value].spaceBetween = this.getSpaceBetween(t)), r = +e["slides_to_show_" + t] || s
                ...
                setSlideshowContent(e) {
                    ...
                    if (e.slides.forEach((e => {
                        ...
                        u = s("<div>", {
                            ...
                            "aria-label": t.next
                        }).html(i), c.append(p, u), this.$buttons = this.$buttons.add(p).add(u)
                    }
